...
public class UserTest {
    ...
    public void addUser() throws SQLException,InvalidSexNameException,UserNotExistException{
        ...
        IUser user = new User("Misha","l2asll","perewer@gmail.com",1);
        IDaoUser daoUser = new DaoUser();
        daoUser.addUser(user,daoDataBase.getStatement());
        IUser newUser = daoUser.getUser(19,daoDataBase.getStatement());
    ...
    public void getUser() throws SQLException,InvalidSexNameException,UserNotExistException{
        ...
        daoDataBase.createConnectionBase();
        IDaoUser daoUser = new DaoUser();
        IUser user = daoUser.getUser(15,daoDataBase.getStatement());
    ...
    public void getSortNamesForMan()throws SQLException{
        ...
        daoDataBase.createConnectionBase();
        IDaoUser daoUser = new DaoUser();
        List<String> listSortNamesForMan = daoUser.getSortNamesByMen(daoDataBase.getStatement());
        ...
        assertEquals("Name is: ","Viktor",listSortNamesForMan.get(4));
    }
    ...
    public void getCountPeopleForEachSex()throws SQLException{
        ...
        daoDataBase.createConnectionBase();
        IDaoUser daoUser = new DaoUser();
        String result = "The sex: 1 has: 5 people The sex: 2 has: 4 people ";
